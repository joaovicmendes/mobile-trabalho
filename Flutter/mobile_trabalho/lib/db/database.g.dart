    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Course` (`id` TEXT NOT NULL, `title` TEXT NOT NULL, `description` TEXT NOT NULL, `rating` INTEGER NOT NULL, `schedule` TEXT NOT NULL, `videoUrl` TEXT NOT NULL, `thumbnail` TEXT NOT NULL, PRIMARY KEY (`id`))');
        await database.execute(
...
class _$CourseDao extends CourseDao {
  ...
  @override
  Future<List<Course>> findAllCoursesById(String id) async {
  ...
  @override
  Future<List<Course>> findAllCoursesByCategory(String category) async {
    return _queryAdapter.queryList('SELECT * FROM Course WHERE category = ?1',
        mapper: (Map<String, Object?> row) => Course(
            row['id'] as String,
            row['title'] as String,
            row['description'] as String,
  ...
  @override
  Future<void> insertCourse(Course user) async {
    await _courseInsertionAdapter.insert(user, OnConflictStrategy.abort);
  }
}
...
class _$CategoryDao extends CategoryDao {
  ...
  @override
  Future<void> insertCategory(Category user) async {
    await _categoryInsertionAdapter.insert(user, OnConflictStrategy.abort);
  }
}
